...
public class LabeledExprParser extends Parser {
	...
	public static final int
		...
		MUL=10, DIV=11, ADD=12, SUB=13, FACTORIAL=14, ID=15, INT=16, NEWLINE=17, 
		WS=18;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ADD", "SUB", "FACTORIAL", "ID", "INT", "NEWLINE", "WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 230380L) != 0) );
			}
		}
	...
	public static class TanContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitTan(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class FactorialContext extends ExprContext {
		...
		public TerminalNode FACTORIAL() { return getToken(LabeledExprParser.FACTORIAL, 0); }
